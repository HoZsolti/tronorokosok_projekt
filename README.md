...
Az első funkció az ún. burger menü. Ez kezeli a mobil menü reszponzív megjelenítését (az 'active' class kapcsolgatásával).
Egy másik funkció a minikvíz. Ez figyeli az opciók kattintását, összegyűjti a felhasználó által adott válaszokat, majd összeadja a pontszámot. A kvíz eredményét egy konténerbe írja, és ha a pontszám 3, külön gratuláló üzenetet küld.
